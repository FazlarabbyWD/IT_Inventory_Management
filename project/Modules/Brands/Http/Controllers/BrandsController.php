...
class BrandsController extends Controller
{
    ...
    $ref = !empty($request->ref) ? $request->ref : (isset($request->exit) ? route('Brands') : route('Brands Create'));
    return redirect()->to($ref)->with('successMessage', 'Brands has been created successfully!.');
