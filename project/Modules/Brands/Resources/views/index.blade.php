				...
				<form method="get" class="row g-3">
					...
					<div class="col-md-2">
						<select name="status" class="form-select">
							...
							<option {!! isset($_GET['status']) && $_GET['status'] == 2 ? 'selected' : '' !!} value="0">Inactive</option>
						</select>
					</div>
					<div class="col-md-2">
						...
						<tr>
							...
							<td>
								<div class="recent-product-img">
									@if(!empty($list->photo))
									<img src="{!! asset('uploads/brands/' . $list->photo) !!}" height="30">
									@endif
								</div>
							</td>
							<td>
							...
							<td>
								<div class="dropdown">
									...
									<ul class="dropdown-menu" style="margin: 0px;">
										<li><a class="dropdown-item" href="{!! route('Brands Edit', $list->id) !!}">Edit</a>
										</li>
										<li><a class="dropdown-item confirmDelete"
											href="{!! route('Brands Delete', $list->id) !!}">Delete</a>
										</li>
									</li>
								</ul>
							</div>
