		...
		<div class="card">
			<div class="card-body p-5">
				<div class="border p-4 rounded">
					<form method="post" action="{!! route('Brands Update', $dataInfo->id) !!}" enctype="multipart/form-data">
						@csrf
							...
							<div class="col-sm-2">
								...
								<div class="fileupload @if(empty($dataInfo->photo)) fileupload-new @endif" data-provides="fileupload" >
									<span class="fileupload-preview fileupload-exists thumbnail" style="max-height: 75px;">
										...
										<img src="{{asset('uploads/brands/'.$dataInfo->photo)}}" width="75px">
										@endif
									</span>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<a href="{!! route('Brands') !!}" class="btn btn-outline-danger px-3">Cancel</a>
							</div>
						</div>
					</form>
				</div>
