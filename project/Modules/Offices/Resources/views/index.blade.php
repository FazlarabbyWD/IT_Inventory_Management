				...
				<table class="table mb-0 table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								@if(!empty($list->photo))
								<img src="{!! asset('uploads/offices/' . $list->photo) !!}" height="30">
								@endif
							</td>
							<td>
							...
							<td>
								<div class="badge rounded-pill bg-light-info {!! $list->status == 1 ? 'text-success' : 'text-info' !!}">{!! $list->status == 1 ? 'Active' : 'Inactive' !!}</div></td>
								<td>
									<div class="dropdown">
										...
										<ul class="dropdown-menu" style="margin: 0px;">
											<li><a class="dropdown-item" href="{!! route('Offices Edit', $list->id) !!}">Edit</a>
											</li>
											<li><a class="dropdown-item confirmDelete"
												href="{!! route('Offices Delete', $list->id) !!}">Delete</a>
											</li>
										</li>
									</ul>
								</div>
