		...
		<div class="card p-5">
			<div class="card-body">
				<div class="border p-4 rounded">
					<form method="post" action="{!! route('Offices Update',$dataInfo->id) !!}" enctype="multipart/form-data">
						@csrf
                        ...
                        <div class="row mb-3">
							...
							<div class="col-sm-9">
								<input type="text" name="website" value="{!! $dataInfo->website !!}" id="website" class="form-control" placeholder="Website">
								@error('website')
								<b>{{ $message }}</b>
								@enderror
							</div>
							...
							<div class="col-sm-9">
								<div class="fileupload @if(empty($dataInfo->photo)) fileupload-new @endif" data-provides="fileupload" >
									<span class="fileupload-preview fileupload-exists thumbnail" style="max-height: 75px;">
										...
										<img src="{{asset('uploads/offices/'.$dataInfo->photo)}}" width="75px">
										@endif
									</span>
