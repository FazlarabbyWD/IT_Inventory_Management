						...
						<tr>
							...
							<td>
								<div class="recent-product-img">
									@if(!empty($list->photo))
									<img src="{!! asset('uploads/categories/'.$list->photo) !!}" height="30">
									@endif
								</div>
							</td>
							<td>
							...
							<td>
								<div class="dropdown">
									...
									<ul class="dropdown-menu" style="margin: 0px;">
										<li><a class="dropdown-item" href="{!! route('Categories Edit', $list->id) !!}">Edit</a>
										</li>
										<li><a class="dropdown-item confirmDelete" href="{!! route('Categories Delete', $list->id) !!}">Delete</a>
										</li>
									</li>
								</ul>
							</div>
