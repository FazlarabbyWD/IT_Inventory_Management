...
class CategoriesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $ref = !empty($request->ref) ? $request->ref : (isset($request->exit) ? route('Categories') : route('Categories Create'));
        return redirect()->to($ref)->with('successMessage', 'Category has been created successfully!.');
