				...
				<div class="border p-4 rounded">
					<form method="post" action="{!! route('Contacts Store') !!}" enctype="multipart/form-data">
						...
						<div class="row mb-3">
							...
							<div class="col-sm-9">
								<input type="text" name="title" value="{!! old('title') !!}" id="title" class="form-control" placeholder="Name" required="required">
								@error('title')
								<b>{{ $message }}</b>
								@enderror
							</div>
						...
						<div class="row mb-3">
							...
							<div class="col-sm-8">
								<select name="contact_type_id" class="form-select single-select" id="contact_type_id">
									...
									<option {!! old('contact_type_id') == $list->id ? 'selected' : '' !!} value="{!! $list->id !!}">{!! $list->title !!}</option>
									@endforeach
									@endif
								</select>
