...
Route::prefix('contacts')->group(function() {
    ...
    Route::get('/ajax/get/list', 'ContactsController@ajaxGetContacts')->name('Contacts Ajax Get List');
    Route::get('/ajax/get/list/bycontacttype/{contactTypeId}', 'ContactsController@ajaxGetContactsByType')->name('Contacts Ajax Get List By Type');
});
