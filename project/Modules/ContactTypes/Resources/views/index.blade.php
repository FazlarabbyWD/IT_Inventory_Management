							...
							<td>
								<div class="dropdown">
									...
									<ul class="dropdown-menu" style="margin: 0px;">
										<li><a class="dropdown-item" href="{!! route('ContactTypes Edit', $list->id) !!}">Edit</a>
										</li>
										<li><a class="dropdown-item confirmDelete" href="{!! route('ContactTypes Delete', $list->id) !!}">Delete</a>
										</li>
									</li>
								</ul>
							</div>
